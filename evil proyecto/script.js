...
//id trae solo id
//query toc especificasr si es clase o id o traer parametro dl html
//--------------------------------------------------------------------------------------------------------------------------------------------//
const mascaraNumero = "####-####-####-####";
const mascaraFecha = "##/##";
//SEPARACION DE FECHA
const mascaraCVV = "###";
//estableciendo los numeros con su respectiva separacion,separada de 4 en 4 por un -

//variables se volveran arreglos para que recorra los elementos y determine la posicion de los datos ingresados por el usuario
//por cada 4 datos ponga un guion


//-------------------------------------------------------------------------------------------------------------------------------------------//

//variables donde cogan los valores ingresados por el usuario

let TarjetaNumero = [];
let FechaNumero = [];
let cvvNumero = [];
//crear solo los arreglos solo se declaran 
